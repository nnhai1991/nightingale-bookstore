...
import com.nightingale.app.entity.TagType;
import com.nightingale.app.exception.ObjectCreationException;

import com.nightingale.app.repository.TagTypeRepository;
import com.nightingale.app.service.TagTypeService;
	...
	public TagType create(TagType tagType) {
		...
		if (tagType != null) {
			try {
				...
				throw new ObjectCreationException(exception.getStackTrace(), "create TagType", "",
	...
	public TagType update(TagType tagType) {
		if (tagType != null) {
			try {
				...
				throw new ObjectCreationException(exception.getStackTrace(), "update TagType", "",
