...
<div>
    ...
    <spring:message code="your_account_has_been_created"/>
    <br/><br/>
    <spring:message code="click_on_the_link"/>
    <br/><br/>
    ...
    <a class="action-button" href="${verifyUrl}">
        <spring:message code="verify_account"/>
    </a>
    <br/><br/>

    <spring:message code="if_you_did_not_sign_up"/>
    <br/><br/>
