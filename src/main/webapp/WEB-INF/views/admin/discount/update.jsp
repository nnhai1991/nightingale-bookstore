	...
	<tiles:putAttribute name="body">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><spring:message code="discount" /></li>
				<li class="breadcrumb-item active"><spring:message
						code="update" /></li>
			</ol>
			<c:url value="/admin/discount/update" var="updateURL">
				<c:param name="${_csrf.parameterName}" value="${_csrf.token}" />
			</c:url>
			<div class="panel panel-default">
				<div class="panel-body">
					<form:form method="POST" action="${updateURL}"
						modelAttribute="discount" cssClass="form-horizontal">
						<form:input type="hidden" path="id" />
						<c:import url="form.jsp"></c:import>
						<div class="form-group">
							<c:url var="homeUrl" value="/admin/discount" />
